...
<div class="table table-responsive">
	...
	<ul class="list-group list-inline" id="menu">
       ...
       <!--<li class="list-group-item text-center dropdown" style="width:180px;"><a href="/project/gallery.php">Gallery</a></li>-->
	   ...
	   <li class="list-group-item text-center active" style="width:180px;"><a href="/project/notifications.php">Notifications</a></li>
...
​	
		<h4>There is blood donation camp in YMCA on 21st March 2017 at Multimedia Center</h4>
	<div id="notice"><img src="images/notification.jpg" height="300px" widht="400px"></div>
</div>
</body>
</html>